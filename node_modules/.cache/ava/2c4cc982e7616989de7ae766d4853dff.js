...
test.afterEach.always('disconnect database', (() => {
...
test('get image', (() => {
  var _ref5 = _asyncToGenerator(function* (t) {
    ...
    // mensaje not found
    yield t.throws((_avaThrowsHelperStart(t, 'throws', 'C:/projects/JavaScript/bikergram/bikergram-db/test/db-test.js', 73), _avaThrowsHelperEnd(t, db.getImage('foo'))), /not found/);
  });
...
test('get user', (() => {
  var _ref8 = _asyncToGenerator(function* (t) {
    ...
    yield t.throws((_avaThrowsHelperStart(t, 'throws', 'C:/projects/JavaScript/bikergram/bikergram-db/test/db-test.js', 113), _avaThrowsHelperEnd(t, db.getUser('foo'))), /not found/);
  });
...
//# sourceMappingURL=..\node_modules\.cache\ava\2c4cc982e7616989de7ae766d4853dff.js.map