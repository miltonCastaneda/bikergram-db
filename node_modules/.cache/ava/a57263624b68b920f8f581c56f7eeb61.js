...
test('like image', (() => {
  var _ref5 = _asyncToGenerator(function* (t) {
    ...
    let image = fixtures.getImage();
    let created = yield db.saveImage(image);
    let result = yield db.likeImage(created)(created.public_id);

    t.true(_rec4._expr(_rec4._capt(_rec4._capt(result, 'arguments/0/object').likes, 'arguments/0'), {
      content: 't.true(result.likes, image.likes + 1)',
      filepath: 'test\\db-test.js',
      line: 52,
      async: true,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"result","range":[7,13]},"property":{"type":"Identifier","name":"likes","range":[14,19]},"computed":false,"range":[7,19]},{"type":"BinaryExpression","operator":"+","left":{"type":"MemberExpression","object":{"type":"Identifier","name":"image","range":[21,26]},"property":{"type":"Identifier","name":"likes","range":[27,32]},"computed":false,"range":[21,32]},"right":{"type":"NumericLiteral","value":1,"range":[35,36]},"range":[21,36]}],"range":[0,37]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"result","range":[7,13]},{"type":{"label":"."},"range":[13,14]},{"type":{"label":"name"},"value":"likes","range":[14,19]},{"type":{"label":","},"range":[19,20]},{"type":{"label":"name"},"value":"image","range":[21,26]},{"type":{"label":"."},"range":[26,27]},{"type":{"label":"name"},"value":"likes","range":[27,32]},{"type":{"label":"+/-"},"value":"+","range":[33,34]},{"type":{"label":"num"},"value":1,"range":[35,36]},{"type":{"label":")"},"range":[36,37]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), image.likes + 1);
  });
...
//# sourceMappingURL=..\node_modules\.cache\ava\a57263624b68b920f8f581c56f7eeb61.js.map