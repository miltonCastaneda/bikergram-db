...
test('get image', (() => {
  var _ref5 = _asyncToGenerator(function* (t) {
    ...
    // mensaje not found
    t.throws((_avaThrowsHelperStart(t, 'throws', 'C:/projects/JavaScript/bikergram/bikergram-db/test/db-test.js', 73), _avaThrowsHelperEnd(t, db.getImage('foo'))), /not found/);
  });
...
test('get user', (() => {
  var _ref8 = _asyncToGenerator(function* (t) {
    ...
    t.throws((_avaThrowsHelperStart(t, 'throws', 'C:/projects/JavaScript/bikergram/bikergram-db/test/db-test.js', 113), _avaThrowsHelperEnd(t, db.getUser('foo'))), /not found/);
  });
...
//# sourceMappingURL=..\node_modules\.cache\ava\28d44980a14a92e5d3f8466b70d55b37.js.map