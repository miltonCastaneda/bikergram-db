...
test('get image', async t => {
  ...
  // verificar que  al obtener una imagen que no existe espero el
  // mensaje not found
...
test('authenticate user', async t => {
  ...
  t.is(typeof db.authenticate, 'function', 'autheticate is a function')
  ...
  t.true(success)
  // probar errores de autenticacion
